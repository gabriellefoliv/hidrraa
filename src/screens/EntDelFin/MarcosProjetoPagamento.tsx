    ...
    <div className="w-full min-h-screen bg-sky-50 p-4 sm:p-6 lg:p-8 font-sans">
      <div className="mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="p-6 sm:p-8">
          <h2 className="text-2xl font-semibold text-sky-800 mb-4 border-b-2 border-sky-200 pb-2">
            Dados do Projeto
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
            ...
            <p className="flex items-center">
              ...
              {project.orcamento || 'Não informado'}
            </p>
          </div>
        </div>
                ...
                >
                          ...
                          >
                            ...
                            <div className="flex flex-col gap-1">
                              <span className="text-xs text-gray-500">
                                Enviado em{' '}
                                {new Date(ev.dataUpload).toLocaleDateString(
                                  'pt-BR',
                                )}
                              </span>
                            </div>
                  ...
                  {marco.relatorio_gerenciadora.length > 0 ? (
                    ...
                    <p className="text-gray-500 italic mt-2">
                      Nenhum relatório apresentado para este marco.
                    </p>
                  )}
                          ...
                          >
                            <div className="flex flex-col">
                              <span className="text-sm text-gray-700">
                                ...
                                {pgto.bc_valor.toLocaleString('pt-BR', {
                                  minimumFractionDigits: 2,
                                })}
                              </span>
                              <span className="text-xs text-gray-500">
                                <strong>Data:</strong>{' '}
                                {new Date(pgto.bc_data).toLocaleDateString(
                                  'pt-BR',
                                )}
                              </span>
                            </div>
                            {/* <span className="text-xs text-gray-500">
S                                Cod. Pagamento: {pgto.codPagtoMarco}
                               </span> */}
                    ...
                    <p className="text-gray-500 italic mt-2">
                      Nenhum pagamento concluído para este marco.
                    </p>
                  )}
                </div>
              ))
              ...
              <p className="text-gray-500 italic text-center py-8">
                Nenhum marco com evidências avaliadas encontrado para este
                projeto.
              </p>
            )}
          </div>
