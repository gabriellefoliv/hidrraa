...
//             setErro("Não foi possível carregar investidor.")
//             setCarregando(false)
//           })
//       } else {
//         setCarregando(false) 
...
//                   {aporte.blockchain?.registrado ? (
//                     <div className="flex flex-col text-green-700">
//                       <span className="font-medium">Registrado na Blockchain ✅</span>
//                       {aporte.blockchain.timestamp && (
//                         <span className="text-gray-500">
//                           {new Date(aporte.blockchain.timestamp).toLocaleString()}
//                         </span>
//                       )}
//                       {aporte.blockchain.hash && (
//                         <a
//                           href={`https://hashscan.io/testnet/transaction/${aporte.blockchain.hash}`}
//                           target="_blank"
...
//                     </div>
//                   ) : (
//                     <span className="text-yellow-700">Aguardando registro na Blockchain...</span>
//                   )}
//                 </div>
//               </li>
//             ))}
