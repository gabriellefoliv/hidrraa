...
export function ProjetoCard({
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        ...
        <div className="flex flex-col items-end gap-2 flex-shrink-0 ml-4">
          ...
          {projeto.caminhoArquivo && (
            ...
            >
              <a
                href={env.API_BASE_URL + `/uploads/${projeto.caminhoArquivo}`}
                target="_blank"
      ...
      {/* Área expansível */}
      <div
        className={`transition-all duration-500 overflow-hidden ${isOpen ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'
          }`}
      >
        {children}
      </div>
